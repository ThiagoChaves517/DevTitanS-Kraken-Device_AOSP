...
# Setam propriedades do sistema para diferentes partições do sistema
...
# Seta os pacotes do AOSP que iremos utilizar neste produto
PRODUCT_PACKAGES += \
...
# Multi Sensors -> SmartlampLightSensor
